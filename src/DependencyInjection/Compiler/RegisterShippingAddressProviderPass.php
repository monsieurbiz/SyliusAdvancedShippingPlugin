...
final class RegisterShippingAddressProviderPass extends AbstractRegisterPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        $this->register(
            ...
            'monsieurbiz.advanced_shipping.shipping_address_provider',
